      ...
      <article>
        ...
        <ul>
          ...
          <li>
            ...
            Company downloaded by You on any electronic device, named spotmies
          </li>
          <li>
            <b>Company</b> (referred to as either "the Company", "We", "Us" or
            "Our" in this Agreement) refers to spotmies LLP, 101,suvarna
            residency,near ramatakies,srinagar,visakhapatnam.
          </li>
          <li>
          ...
          <li>
            <b>Country</b> refers to: Andhra Pradesh, India
          </li>
          <li>
          ...
          <li>
            <b> Website</b> refers to Spotmies, accessible from{" "}
            <a href="https://www.spotmies.com/"> https://www.spotmies.com/#/</a>
          </li>
          <li>
      ...
      <article ref={ref1}>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://www.adobe.com/products/flashplayer/end-of-life.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"></a>
        ...
        <p>
          ...
          browser. Learn more about cookies: Cookies by PrivacyPolicies
          Generator.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://spotmies.com/"> https://www.spotmies.com/#/</a>
          </li>
        </ul>
      </article>
    </div>
