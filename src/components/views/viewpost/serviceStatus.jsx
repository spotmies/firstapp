    ...
    <div style={{ position: "relative" }}>
      <div className="service-status">
        <div className="status-line1">
          <div className="status-line"   style={{height:`${getHeight()}%`}}></div>
        </div>
        ...
        <div className="status-details">
          <FaUserCheck className={props.status >= 5 ? "status-icons1" : "status-icons"} />
          <p>Order Accepted</p>
        </div>
        <div className="status-details">
          <FaWrench className={props.status >= 6 ? "status-icons1" : "status-icons"} />
          <p>Service Started</p>
        </div>
        <div className="status-details">
